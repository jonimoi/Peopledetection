...
# Huge credits to https://github.com/EdjeElectronics for great tips about how to get
# tensorflow up and running properly on RPi3.
#
# TIP: If you dont want your telegram-app spammed with notifications, you need to add
# a timer or a counter to the detection/bot.sendMessage.
#
# https://github.com/jonimoi
######################################################################################
...
# Set up camera constants, the smaller the better for higher framerate
IM_WIDTH = 300
IM_HEIGHT = 300
...
if camera_type == 'picamera':
    ...
    for frame1 in camera.capture_continuous(rawCapture, format="bgr",use_video_port=True):
        ...
        # Find 'person' of all the objects that's accessible in the net
